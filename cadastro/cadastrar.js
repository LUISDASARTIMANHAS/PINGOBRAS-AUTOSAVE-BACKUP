...
nome.addEventListener("keyup", atualizar);
usuario.addEventListener("keyup", atualizar);
senha.addEventListener("keyup", atualizar);
confirmSenha.addEventListener("keyup", atualizar);
